...
// const CONTRACT_ADDRESS = '0x1B859A029466c34432abF17123a5391f4A121c42'
const CONTRACT_ADDRESS = '0x6B654df83B683Fd4fC4dd88dC19286cdC031711a'
...
async function setGlobalStatisticsEvents (contract) {
    const [invested, withdrawn] = await contract.contractInfo()
...
async function setPersonalStatistics (contract, currentAccount) {
    const [forWithdraw, totalInvested, totalWithdrawn, structure] = await contract.userInfo(currentAccount)
    updatePersonalStatisticsDashboard(forWithdraw, totalInvested, totalWithdrawn, structure)

    showRefLink(totalInvested, currentAccount)
}

function updatePersonalStatisticsDashboard(forWithdraw, totalInvested, totalWithdrawn, structure) {
